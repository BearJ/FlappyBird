var statePlay = {
    create: function() {
        ...
        var readyText = game.add.sprite(game.width / 2, 100, "ready_text");
        readyText.anchor.setTo(.5, .5);

        var birdTop = 200,
            bird = game.add.sprite(game.width / 2 - 60, 200, "bird");
        ...
        var tutorial = game.add.sprite(game.width / 2, 230, "tutorial");
